    ...
    <div class="container">
      <div class="header-topbar hidden-xs link-border">
        <ul class="site-nav topmenu">
         ...
         <a data-toggle="modal" data-target="${loginUser == null ? '#loginModal' : '' }" class="login" rel="nofollow">
         ${loginUser == null ? 'Hi,请登录' : '欢迎:'.concat(loginUser.cnName)}</a>
        &nbsp;&nbsp;<a href="javascript:;" class="register" rel="nofollow">我要注册
        </a>&nbsp;&nbsp;<a href="" rel="nofollow">找回密码</a> </div>
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="hidden-index active"><a data-cont="异清轩首页" href="index">异清轩首页</a></li>
	         <c:forEach items="${cList}" var="l">
	          <li><a href="category?id=${l.id}&name=${l.name}">${l.name}</a></li>
	          </c:forEach>
        </ul>
