...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/page-learing-article.css" />
</head>
...
<body data-spy="scroll" data-target="#articleNavbar" data-offset="150">
    ...
    <div class="article-banner">
        ...
        <div class="banner-info">
            ...
            <div class="banner-rit">
                <p><img src="${pageContext.request.contextPath}/img/widget-video.png" alt=""> </p>
                <p class="vid-act"><span>
    ...
    <div class="article-cont" id = "app">
        <div class="tit-list">
            ...
            <a href="#" id="artcleCod" onclick="commentNum()">评价</a>
            <div class="down-fill">
                <span>资料下载</span>
                <ul>
                    <li>java视频资料</li>
                ...
                <div class="article-cont">
                    <div class="article-left-box">
                        <div class="content">
                            ...
                            <div class="content-com course">
                                ...
                                <div class="cont">
                                    <div class="img-box"><img src="${pageContext.request.contextPath}/img/widget-pic.png" alt=""></div>
                                    <div class="info-box">
                    ...
                    <div class="article-right-box">
                        <div class="comment">
                            ...
                            <div class="com-cont">
                                <div class="item">
                                    <div class="top-info"><img src="${pageContext.request.contextPath}/img/widget-pic.png" width="30px" alt="">
                                        <div class="info">
                                            <p>毛老师</p>
                        ...
                        <div class="learing-box">
                            ...
                            <div class="com-cont">
                                <a href="#" class="item">
                                    <p><img src="${pageContext.request.contextPath}/img/widget-pic.png" width="30px" alt=""></p>
                                    <p>毛老师</p>
                                </a>
                                <a href="#" class="item">
                                    <p><img src="${pageContext.request.contextPath}/img/widget-pic.png" width="30px" alt=""></p>
                ...
                <div class="article-cont">
                        ...
                        <label><input name="eval" type="radio" value="" /> 完成者 </label> -->
                                ...
                                <div class="top-cont">
                                    ...
                                    <div class="cont-top-right">
                                        <div class="star-grade">好评
                                            <div class="grade">
                                                <div class="grade-percent"><span id="nice" ></span></div>
                                                <div class="percent-num" ><span id="goodComment">30</span>%</div>
                                            </div>
                                        </div>
                                        <div class="star-grade">中评
                                            <div class="grade">
                                                <div class="grade-percent"><span id="medium"></span></div>
                                                <div class="percent-num" ><i >30</i>%</div>
                                            </div>
                                        </div>
                                        <div class="star-grade">差评
                                            <div class="grade">
                                                <div class="grade-percent"><span id="poor" ></span></div>
                                ...
                                <div class="comment-item-box" name="comment">
                                    <div class="title">评论 <span>12453条评论</span></div>
                                    
                                    <div class="item" v-for="comment in commentList">
                                        <div class="item-left">
                                            <p><img :src="comment.xcUser.userPic" width="60px" alt=""></p>
                                            <p id="xcUser">{{comment.xcUser.username}}</p>
                                        </div>
                                        <div class="item-cent">
                                            <p>{{comment.content}}</p>
                                        ...
                                        <div class="item-rit">
                                        <input type="hidden" value="" id="goods">
                                        <input type="hidden" value="" id="kind">
                                        <input type="hidden" value="" id="bad">
                                        <input type="hidden" value="" id="numbers">
                                            <p>
                                               <!--  <div class="star-show">
                                                    <div class="score" id="scores"><i>{{comment.grade}}</i></div>
                                                </div> -->
                                            </p>
                    ...
                    function commentNum(){
			            ...
			            $('.grade').map(function(n, i) {
			            	var a =  kind /str * 100 ; //中评
			            	 showData(a,'#medium');
			            	var b = goods / str * 100;//好评
			            	showData(b,'#nice');
			            	$('#iNice').val(b);
			            	var c = bad / str * 100;//差评
			            	showData(c,'#poor');
			            	$("goodComment").val(b);
			            }) ; 
                    	});
                    }
                    function showData(date,url){
                    	 $(".top-cont").find('.grade-percent '+url+'').css('width', Math.ceil(date));
                    }
</script>
                    <div class="article-right-box">
                        <div class="about-teach">
